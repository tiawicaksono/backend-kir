...
class SyncKendaraan extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($data as $row) {
             ...
             * KONFIGURASI SUMBU
             */
            $konfigurasi_sumbu_id = 1;
            if ($row->conf_sumbu == '1.1') {
                $konfigurasi_sumbu_id = 1;
            } elseif ($row->conf_sumbu == '1.1.2') {
                $konfigurasi_sumbu_id = 2;
            } elseif ($row->conf_sumbu == '1.2') {
                $konfigurasi_sumbu_id = 3;
            } elseif ($row->conf_sumbu == '1.2.2') {
                $konfigurasi_sumbu_id = 4;
            } elseif ($row->conf_sumbu == '1.1.2.2') {
                $konfigurasi_sumbu_id = 5;
            } elseif ($row->conf_sumbu == '2.2') {
                $konfigurasi_sumbu_id = 6;
            } elseif ($row->conf_sumbu == '2.2.2') {
                $konfigurasi_sumbu_id = 7;
            } elseif ($row->conf_sumbu == '1.1.1') {
                $konfigurasi_sumbu_id = 8;
            } elseif ($row->conf_sumbu == '1.2.1') {
                $konfigurasi_sumbu_id = 9;
            }

            // insert master kendaraan
            $id = DB::table('m_kendaraans')->insertGetId([
                'id' => $id,
                'no_sut' => $row->no_tipe,
            ...
            // insert spesifikasi
            DB::table('m_kendaraan_spesifikasis')->insert([
                'kendaraan_id' => $id,
